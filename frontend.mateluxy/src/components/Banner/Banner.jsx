        ...
        <>
          ...
          <div className="sm:hidden absolute bottom-0 left-1/2 w-full flex flex-col items-center justify-end pb-6 px-4 transform -translate-x-1/2 bg-gradient-to-t from-black/70 via-black/10 to-transparent">
            ...
            <div className="flex flex-wrap justify-center gap-3 w-full mt-2">
              ...
              <Link to={slides[currentSlide]?.buttonLink2 || '/properties'} className="px-4 py-2 text-xs font-medium rounded-full bg-[#FF2626] text-white hover:bg-[#FF4040] transition-all duration-300">
