...
const OffPlanBanner = () => {
  ...
  const placeholderSlide = {
    ...
    title: "Fairmont Residences",
    subtitle: "Solara Tower",
          ...
          <div className="hidden sm:flex flex-col justify-center h-full relative z-10">
            <div className="max-w-2xl px-8 md:px-16 py-12">
              ...
              <div className="flex flex-wrap gap-4 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
                ...
                <Link to={slides[currentSlide]?.buttonLink2 || '#'} className="px-6 py-3 text-sm md:text-base font-medium rounded-full bg-[#FF2626] text-white hover:bg-[#FF4040] transition-all duration-300">
