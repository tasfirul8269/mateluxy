...
const CommercialRent = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        // 1. Check if there are properties with 'Commercial for Rent' category
        let categoryFiltered = res.data.filter(property => property.category === 'Commercial for Rent');
        console.log('Properties with Commercial for Rent category:', categoryFiltered);
        
        // 2. If no results, try filtering by 'Rent' category and commercial property types
        if (categoryFiltered.length === 0) {
          ...
          console.log('Properties with Rent category and commercial types:', categoryFiltered);
        }
  ...
  const handleMapViewClick = () => {
    navigate('/map-view/commercial-rent');
  };
